...
public class EmployeeController {
	...
	public ModelAndView loadUpdateEmployee2(@ModelAttribute("empObj") EmployeeBean EmployeeBean) throws Exception {
		...
		//System.out.println("6666666666666666666666666666666666666" +EmployeeBean.getId()+"kkkkk  "+employee2.getName());
		ModelAndView modelAndView = new ModelAndView();
		modelAndView.setViewName("UpdateEmployee");
	...
	public ModelAndView handleInvalidUpdateOperationException(InvalidUpdateOperationException exception){
		ModelAndView  modelAndView = new ModelAndView();
		modelAndView.addObject("message", exception.getMessage()+"ssssssssssss");
		modelAndView.addObject("exception", exception+"gggggggggggggggggggg");
		modelAndView.addObject("empObj", new EmployeeBean());
		modelAndView.setViewName("UpdateEmployee");
		return modelAndView;
	}
	...
	public ModelAndView handleAllExceptions(Exception exception){
		...
		modelAndView.addObject("message", exception.getMessage()+"hhhhhhhh");
		modelAndView.addObject("exception", exception+"ppppppppppppppp");
		return modelAndView;
	}
