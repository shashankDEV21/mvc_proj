...
@Controller
@SessionAttributes("employeeBean") //comment this and check
public class EmployeeController {
	...
	public ModelAndView register(@ModelAttribute("employeeBean") EmployeeBean employeeBean,ModelMap map,HttpServletRequest req,HttpSession sess) {
		System.out.println("Register Handler");
		System.out.println("================");
		System.out.println("Model Data: "+map.get("employeeBean"));// print object
		System.out.println("Request: "+req.getAttribute("employeeBean"));//null
		//sess.setAttribute("key", SomeObject)
