...
public class CompliantReportController {
	...
	@RequestMapping(value="/loadCompliantReport", method=RequestMethod.GET)
	...
	public ModelAndView getCompliantDetailsByDate(@ModelAttribute("daterangeBean")DateRangeBean dateRange) {
		...
		List<CompliantBean> compliants=cs.getCompliantDetailsByDate(dateRange.getFromDate(), dateRange.getToDate());
